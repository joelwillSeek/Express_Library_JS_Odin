...
exports.book_create_get = expressAsyncHandler(async (req, res, next) => {
...
exports.book_update_get = expressAsyncHandler(async (req, res, next) => {
...
exports.book_delete_get = expressAsyncHandler(async (req, res, next) => {
  const [book, bookInstances] = await Promise.all([
    Book.findById(req.params.id).populate("author").populate("genre").exec(),
    BookInstance.find({ book: req.params.id }).exec(),
  ]);
...
exports.book_delete_post = expressAsyncHandler(async (req, res, next) => {
