...
exports.bookinstance_create_get = expressAsyncHandler(
  async (req, res, next) => {
...
exports.bookinstance_create_post = [
  ...
  expressAsyncHandler(async (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      res.redirect(bookInstance.urlFormatted);
    }
  }),
];

exports.bookinstance_delete_get = expressAsyncHandler(
  async (req, res, next) => {
    const bookInstance = await BookInstance.findById(req.params.id)
      .populate("book")
      .exec();
...
exports.bookinstance_delete_post = expressAsyncHandler(
  async (req, res, next) => {
...
exports.bookinstance_update_get = expressAsyncHandler(
  async (req, res, next) => {
